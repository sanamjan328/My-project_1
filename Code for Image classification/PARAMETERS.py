...
#######################################
# Some important parameters for demo
#######################################
#  Name of the image directory, e.g. C:\MAMP\htdocs\public\backend\uploads\2017
...
svm_CVal = 0.1  # Slack penalty parameter C for SVM training
...
svm_hardNegMinging_maxNrRoundsPerIter = 100000  # Maximum number of image pairs tested during one hard negative
# iteration
...
# rootDir      = os.path.dirname(os.path.dirname(os.path.realpath(sys.argv[0]))).replace("\\","/")+"/"
rootDir = os.path.dirname(os.path.realpath(sys.argv[0])).replace("\\", "/") + "/"
imgDir = rootDir + "data/" + datasetName + "/"
# imgDir       = "C://MAMP/htdocs/public/backend/uploads/"    + datasetName + "/"
...
# Files
imgUrlsPath = resourcesDir + "FurnituresUrls.tsv"
